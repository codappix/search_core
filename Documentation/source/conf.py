# -*- coding: utf-8 -*-
#
# TYPO3 Extension search_core documentation build configuration file, created by
...
project = u'TYPO3 Extension search_core'
...
htmlhelp_basename = 'TYPO3Extensionsearch_coredoc'
...
latex_documents = [
    (master_doc, 'TYPO3Extensionsearch_core.tex', u'TYPO3 Extension search\\_core Documentation',
...
man_pages = [
    (master_doc, 'typo3extensionsearch_core', u'TYPO3 Extension search_core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TYPO3Extensionsearch_core', u'TYPO3 Extension search_core Documentation',
     author, 'TYPO3Extensionsearch_core', 'One line description of project.',
     'Miscellaneous'),
]
